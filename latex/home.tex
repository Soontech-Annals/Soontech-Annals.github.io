...
\item{
   \href{https://discord.gg/dkSM2PyzJe}{\textbf{Soontech Discord}}: A community-run public Discord server for developing and learning about encoded storage technology in Minecraft. This server is open to anyone, and features weekly classes and public Minecraft servers for practical learning.
}
\end{itemize}
